...
def test_init():
    ...
    game = GameState(players=players, deck=full_deck, current_player=1, top=Card.load('y7'))
...
def test_current_player():
    ...
    game = GameState(players=players, deck=full_deck, top=Card.load('y7'), current_player=1)
